...
window.__fwoosh = {
  ...
  state(){ return {
    ...
    arson:arson.length, intercepts, edge:+edge.toFixed(2), keithPressureCount,
    encounterStress:typeof encounterStress==='function'?+encounterStress().toFixed(3):null,
    keithCadence:typeof keithPressureCadence==='function'?+keithPressureCadence().toFixed(3):null,
    keithStrike:keithStrike ? {t:+keithStrike.t.toFixed(2),done:keithStrike.done} : null,
