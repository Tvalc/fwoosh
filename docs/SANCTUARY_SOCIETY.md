...
Monsters wiped out the nomadic forest tribe's village and captured its last nineteen survivors. Duy and Cuong subsequently killed those nineteen captives. These are distinct events; nineteen is neither the tribe's original population nor a sanctuary population cap. That whole society is the first rebuilt in sanctuary, with shared memories and relationships. The goal extends beyond restoring what was lost: help the society grow, expand and build a better future. The individually authored cast/backlog must extend beyond the nineteen. Arrivals from other worlds follow later, revealing the breadth of the multiversal sanctuary over time.

How their nomadic forest culture shapes new housing, settlement and travel remains under interview. Do not assume they abandon that culture or that nomadism itself was forced. The community's name, individual biographies, arrival order and specific traditions have not yet been authored or approved. The earlier warning against assuming the whole tribe died is superseded by Tony's clarification that the nineteen captives were its last survivors.
