...
- Invoice conversion, caps and reward thresholds. Lifetime earned embers is locked; spending in Fwoosh does not reduce that basis. Legacy missing earnings still require a remedy before final redemption.
